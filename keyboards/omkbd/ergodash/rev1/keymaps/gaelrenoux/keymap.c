...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * Bépo version:
   * ,----------------------------------------------------------------------------------------------------------------------.
   * | ESC  |  1 " |  2 < |  3 > |  4 ( |  5 ) |   ç  |                    | CapsL|  6 @ |  + 7 |  - 8 |  / 9 |  * 0 |   =  |
   * |------+------+------+------+------+------+------+--------------------+------+------+------+------+------+------+------|
   * |  $   |   b  |   é  |   p  |   o  |   è  |Pscree|                    |   %  |   ^  |   v  |   d  |   l  |   j  |  z   |
   * |------+------+------+------+------+------+------+--------------------+------+------+------+------+------+------+------|
   ...
   */
  [_QWERTY] = LAYOUT(
    KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_BSLS,                        KC_CAPS, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS,
